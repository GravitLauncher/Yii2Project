...
<li>Дайте права на выполнение файлу setsignsize. Командой chmod +x /путь_до/setsignsize<br>
Если при создании приватного ключа задавали пароль, то откройте файлы sign-update.sh и sign.sh и пропишите его после -pass</li>
...
<span class="codes">openssl ecparam -name prime256v1 -genkey -out private.key</span><br>
Где prime256v1 -  название эллиптической кривой<br>
