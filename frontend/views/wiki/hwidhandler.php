...
"hwidHandler": {
     ...
     "paramsHwids": [ "%totalMemory%", "%serialNumber%", "%HWDiskSerial%", "%processorID%", "%macAddr%" ],                                                                // параметры sql запроса
     ...
     "paramsBan": [ "%isBanned%", "%totalMemory%", "%serialNumber%", "%HWDiskSerial%", "%processorID%", "%macAddr%" ],                                                    // параметры sql запроса
     ...
     "hwidFieldMacAddr": "macAddr",            // название столбца с MAC адресом сетевой карты пользователя
