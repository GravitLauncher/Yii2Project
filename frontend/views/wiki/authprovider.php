...
Этот способ НЕ подходит для сайтов с нестандартными алгоритмами хеширования (поддерживается только md5)<br>
mySQLHolder<br>
...
<h3>Способ json</h3>
<p>Для проверки логина-пароля лаунчсервер обращается к сайту по протоколу HTTP/HTTPS, но в отличии от request делает POST запрос с json данными внутри<br>
url - ссылка до скрипта<br>
